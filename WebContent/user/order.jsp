...
<!--文件体开始-->
		...
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="user/OrderDetailSer?orderid=${order.orderid}">${order.orderid}</a></td>
			...
			<input type="button" value="删除" onclick="javascript:window.location='user/removeOrderSer?orderid=${order.orderid}';">&nbsp;<input type="button" value="明细" onclick="javascript:window.location='user/OrderDetailSer?orderid=${order.orderid}';"><!--&nbsp;<input type="button" value="修改"/>--> </td>
		</tr>
               </c:forEach> 
                </table><br>
<!--文件尾开始-->
