...
<!--文件体开始-->
		...
		<tr>
			...
			<td class=tablebody1 valign=middle width="">&nbsp;&nbsp;<a href="productDetailSer?product_id=${entry.key}">${entry.value.name}</a></td>
			<td class=tablebody2 valign=middle align=center width="">${entry.value.baseprice}</td>
			<td class=tablebody1 valign=middle align=center width=""><a href="user/addProductSer?product_id=${entry.key}">
